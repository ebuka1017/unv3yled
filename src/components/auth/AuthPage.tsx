      ...
      <Card className="w-full max-w-md glass-card">
        <CardHeader className="text-center">
          <div className="flex items-center justify-between w-full mb-4">
            <Button variant="ghost" size="sm" onClick={() => navigate('/')} className="rounded-full p-2 text-gray-600 bg-pink-300 hover:bg-pink-200">
        ...
        <CardContent className="space-y-6">
          ...
          <Button onClick={handleSpotifyConnect} disabled={isConnecting || isConnectingGoogle} className="w-full pill-button text-lg py-6" size="lg">
            {isConnecting ? <>
          ...
          <Button onClick={handleGoogleConnect} disabled={isConnecting || isConnectingGoogle} variant="outline" className="w-full pill-button text-lg py-6" size="lg">
            {isConnectingGoogle ? <>
                <Loader2 className="w-5 h-5 mr-2 animate-spin" />
                Connecting...
              </> : <>
